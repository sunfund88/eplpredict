...
export default async function UserDetailPage({ params }: { params: { lineId: string } }) {
  ...
  return (
    <div className="min-h-screen bg-[#38003c] text-white">
      {/* Header พื้นหลังสีม่วงเข้มแบบ FPL */}
      ...
      <div className="px-6 -mt-16">
        <div className="flex flex-col items-center">
          ...
          <div className="mt-2 inline-block px-4 py-1 bg-[#00ff85] text-[#38003c] rounded-full font-bold text-sm">
          ...
          <div className="grid gap-4">
            {user.predictions.length > 0 ? (
              user.predictions.map((pred) => (
                <div 
                  key={pred.id} 
                  className="bg-white/5 border border-white/5 p-4 rounded-3xl flex items-center justify-between"
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="bg-white/10 px-4 py-2 rounded-xl text-center min-w-[80px]">
                      <p className="text-xs opacity-50 mb-1 leading-none uppercase">Pred.</p>
                    ...
                    <div className="text-center">
                      <p className="text-xs opacity-50 mb-1 leading-none uppercase">Pts</p>
